...
# Form implementation generated from reading ui file 'spartan/ui/ui_prefwindow.ui',
# licensing of 'spartan/ui/ui_prefwindow.ui' applies.
#
...
class Ui_PrefWindow(object):
    ...
    def retranslateUi(self, PrefWindow):
        PrefWindow.setWindowTitle(QtWidgets.QApplication.translate("PrefWindow", "WoWHealth - Settings", None, -1))
